...
Paciente $paciente, con número de afiliación $afiliacion consultó el día $dia de $mes de 201$anio en el Servicio de $servicio de este Centro Hospitalario, con diagnóstico de $diagnostico; permaneciendo ingresada/o, hasta el día $dia2 de $mes2 de 201$anio2, fecha de alta con diagnóstico $diagnostico2.-----------------
...
$pdf->Output('Constancia_Alta.pdf', 'I');
