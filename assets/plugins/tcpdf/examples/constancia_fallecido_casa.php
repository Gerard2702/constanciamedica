...
$pdf->SetTitle('Constancia Fallecido en Casa');
...
$extendidaden = "San Pedro Perulapan";
$dia4 = "1";
$mes4 = "Marzo";
$anio4 = "8";
...
Paciente $paciente, con número de afiliación $afiliacion, consultó el día $dia de $mes de 201$anio en el Servicio de $servicio de este Centro Hospitalario, con diagnóstico $diagnostico; área en la que permaneció hasta la fecha de alta el día "dia2" de $mes2 de 201$anio2. Según Partida de Defunción Extendida el día $dia3 de $mes3 de 201$anio3 en $extendidaden, paciente fallecido en su domicilio el día $dia4 de $mes4 de 201$anio4. 
...
$pdf->Output('Constancia_Fallecido_Casa.pdf', 'I');
