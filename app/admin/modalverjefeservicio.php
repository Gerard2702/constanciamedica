<?php 
	...
	$id = $_POST['idjefeservicio'];
	$sql1="SELECT us.nombre,sta.id_status,sta.nombre_status,ser.id_servicio,ser.nombre_servicio FROM jefe_servicio us INNER JOIN status sta ON us.id_status=sta.id_status INNER JOIN servicios ser ON us.id_servicio=ser.id_servicio WHERE us.id_jefe=?";
	...
	$conn->close();
 ?>
 <form class="form-horizontal form-variance" method="POST" action="../class/admin/editarjefeservicio.php">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <select class="form-control" name="estado" id="esatdo">
            	<?php 
                    if($rows3>0) {
                        while ($stmt3->fetch()) {
