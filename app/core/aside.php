...
<aside id="aside" class="ui-aside ui-aside--light">
    <ul class="nav" ui-nav id="mimenu">
        ...
        <li id="reporteria">
            <a href=""><i class="fa fa-bar-chart"></i><span>Reportes</span><i class="fa fa-angle-right pull-right"></i></a>
            <ul class="nav nav-sub">
                <li id="SolicitudesF"><a href="../admin/Reporte.php"><span>Constancias Finalizadas</span></a></li>
                <li id="SolicitudesP"><a href="../admin/ReportePendiente.php"><span>Constancias Pendientes</span></a></li>
            </ul>
        </li>
		<?php
				break;
