...
-- Volcando datos para la tabla ts2.comentarios: ~17 rows (aproximadamente)
...
INSERT INTO `datos_complementarios` (`id_datosc`, `id_constancia`, `id_datos`, `fecha_consulta`, `id_servicio`, `diagnostico`, `nombre_solicitante`, `parentesco`, `destino`, `fecha_extension`, `id_medico`, `id_jefe`, `id_jefesocial`, `id_director`, `estado`, `fecha_entregada`) VALUES
	...
	(7, 2, 5, '2017-12-14', 7, 'Hemorragia Gastrointestinal, ingresando al Servicio de Medicina Tres el mismo día con igual diagnóstico', 'Sr. LUIS JAVIER GUTIERREZ RUIZ ', 'hijo de paciente', 'REGISTRO NACIONAL DE PERSONAS NATURALES', '2018-01-05', 3, 2, 3, 3, 0, '2018-03-20'),
	(9, 4, 1, '2018-03-07', 7, 'Dolor de cabeza 2', 'CARLOS CARLOS PEREZ', 'Padre de paciente', 'AFP CONFIA', '2018-03-07', NULL, 2, 3, 3, 0, NULL),
	...
	(16, 1, 5, '2018-03-20', 6, 'asdasd', '', '', '', '0000-00-00', 5, NULL, 3, NULL, 0, '2018-03-20');
...
-- Volcando datos para la tabla ts2.datos_const_alta: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla ts2.datos_const_fallecimiento_casa: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla ts2.datos_const_ingreso: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla ts2.datos_iniciales: ~12 rows (aproximadamente)
...
INSERT INTO `datos_iniciales` (`id_datos`, `fecha`, `numero_recibo`, `afiliacion_dui`, `nombre_paciente`, `destinos`, `id_servicio`, `cantidad`, `fecha_presentado`, `fecha_cancelado`, `precio`, `id_estado`, `id_trabajador`, `fecha_recibido_revision`, `fecha_autorizacion_direccion`) VALUES
	...
	(2, '2018-02-25', '2147483647', '378592877', 'ROBERTO DE JESUS GUTIERREZ BALDIZON', 'BANCO CITI', 7, 1, '2018-02-25', '2018-02-25', 2.75, 5, 2, NULL, NULL),
	...
	(5, '2018-02-25', '2147483647', '175562116', 'LUIS EDGARDO GUTIERREZ TOBAR', 'REGISTRO NACIONAL DE PERSONAS NATURALES', 6, 1, '2018-02-25', '2018-02-25', 2.75, 6, 2, NULL, NULL),
	(6, '2018-02-26', '1234564123', '123456789', 'ALFONSO CASTRO', 'AFP CONFIA', 7, 1, '2018-02-26', '2018-02-26', 2.75, 6, 2, NULL, NULL),
	...
	(8, '2018-02-27', '1222122332', '111212212', 'GERARDO ADOLFO ORELLANA PEREZ', 'AFP CONFIA', 7, 2, '2018-02-27', '2018-02-27', 2.75, 6, 2, NULL, NULL),
	...
	(12, '2018-03-12', '1121121211', '122212111', 'GERARD MASTER', 'DAVIVIENDA', 4, 2, '2018-03-12', '2018-03-12', 2.75, 6, 1, NULL, NULL);
